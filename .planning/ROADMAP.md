...
- [x] 01-02-PLAN.md — Wave 1: CLI 주입구 패치 (--only-ads · --preview-out · accounts · 항목단위 result/error)
- [x] 01-03-PLAN.md — Wave 1: 보안 3층(127.0.0.1 · Host · Origin · 부팅토큰) + 앱 셸 + 기동 스크립트
...
- [x] 01-05-PLAN.md — Wave 3: 작업 엔진(argv · jobs SQLite · subprocess · 쓰기 잡 전역 가드) + "새로 수집" 버튼
...
- [x] 03-07-PLAN.md — 실탄: 재개 회귀 + 첫 인덱스 구축 완주(체크포인트) + 보드 최종 확인 + VALIDATION 마감
      → **7/7 완료.** 인덱스 30,546행/30그룹/미조회 0 (2시간 8분 · 429 0회) · 보드 상품 연결 51 (🔴31 🟡20 ⚪0) · 테스트 340 green · `/gsd:verify-work` 대기
